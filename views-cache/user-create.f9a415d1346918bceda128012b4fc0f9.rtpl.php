    ...
    <div class="register-box">
        ...
        <div class="content-box">
            <form method="post" action="/admin/user/create" class="form-group" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <label for="user_email" class="label-input">user_ <span class="mandatory">*</span></label>
                    <input type="user_email" class="text-input" id="user_email" name="user_email">
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <input type="user_password" class="text-input" id="user_password" name="user_password">
                </div>
                <div class="input-group">
                ...
                <div class="input-group">
                    <label for="boardId" class="label-input">Administrador<span class="mandatory">*</span></label>
