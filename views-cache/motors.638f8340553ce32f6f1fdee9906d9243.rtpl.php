<?php if(!class_exists('Rain\Tpl')){exit;}?><title>Motores</title>
        ...
        <div class="list-body-content">
            <div class="list-body-top">
                ...
                <div class="list-category-sub-title">
                    <p class="list-sub-title">lista de motores</p>
                </div>
            </div>
            <div class="list-body-middle">
                <div class="list-table-body">
                    <table>
                        ...
                        <tbody>
                             <?php $counter1=-1;  if( isset($motors) && ( is_array($motors) || $motors instanceof Traversable ) && sizeof($motors) ) foreach( $motors as $key1 => $value1 ){ $counter1++; ?>
                            <tr>
                ...
                <div class="new-element">
                    <a href="./motor/create" class="new-element-button">
                        <button>
                            Incluir novo
                        </button>
                    </a>
